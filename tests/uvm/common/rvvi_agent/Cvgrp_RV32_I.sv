...
covergroup cvgrp_RV32_I;
  ...
  rs1_val_eq_rs2_val: coverpoint rv32i_trans.rs1_val==rv32i_trans.rs2_val iff(rv32i_trans.trap==0) {
    bins b0 = {0}; bins b1 = {1}; option.weight = 1;
  }
  ...
  cr_lw_mem_unalign: cross lw, word_mem_unalign{
    ...
    bins lw_mem_unalign_one_byte = binsof(lw) intersect {LW} && binsof(word_mem_unalign) intersect {
      1
    };
    bins lw_mem_unalign_two_byte = binsof(lw) intersect {LW} && binsof(word_mem_unalign) intersect {
      2
    };
    bins lw_mem_unalign_three_byte = binsof(lw) intersect {LW} && binsof(word_mem_unalign) intersect {
      3
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_lw_mem_start_addr: cross lw, mem_start_addr{option.weight = 1;}
  ...
  cr_lhu_mem_unalign: cross lhu, half_word_mem_unalign{
    bins lhu_mem_align = binsof (lhu) intersect {LHU} && binsof (half_word_mem_unalign) intersect {
      0
    };
    bins lhu_mem_unalign = binsof(lhu) intersect {LHU} && binsof(half_word_mem_unalign) intersect {
      1
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_sh_mem_unalign: cross sh, half_word_mem_unalign{
    ...
    bins sh_mem_unalign = binsof (sh) intersect {SH} && binsof (half_word_mem_unalign) intersect {
      1
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_sw_mem_unalign: cross sw, word_mem_unalign{
    ...
    bins sw_mem_unalign_one_byte = binsof(sw) intersect {SW} && binsof(word_mem_unalign) intersect {
      1
    };
    bins sw_mem_unalign_two_byte = binsof(sw) intersect {SW} && binsof(word_mem_unalign) intersect {
      2
    };
    bins sw_mem_unalign_three_byte = binsof(sw) intersect {SW} && binsof(word_mem_unalign) intersect {
      3
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_sw_mem_start_addr: cross sw, mem_start_addr{option.weight = 1;}
  ...
  cr_beq_rs1_val_rs2_val_eqval: cross beq, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(beq) intersect {BEQ} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(beq) intersect {BEQ} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_bne_rs1_val_rs2_val_eqval: cross bne, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(bne) intersect {BNE} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(bne) intersect {BNE} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_blt_rs1_val_rs2_val_eqval: cross blt, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(blt) intersect {BLT} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(blt) intersect {BLT} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_bge_rs1_val_rs2_val_eqval: cross bge, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(bge) intersect {BGE} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(bge) intersect {BGE} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_bltu_rs1_val_rs2_val_eqval: cross bltu, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(bltu) intersect {BLTU} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(bltu) intersect {BLTU} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_bgeu_rs1_val_rs2_val_eqval: cross bgeu, rs1_val_eq_rs2_val{
    bins  rs1_val_eqval_rs2_val = binsof(bgeu) intersect {BGEU} && binsof(rs1_val_eq_rs2_val) intersect {
      1
    };
    bins  rs1_val_neval_rs2_val = binsof(bgeu) intersect {BGEU} && binsof(rs1_val_eq_rs2_val) intersect {
      0
    };
    option.weight = 1;
    option.cross_auto_bin_max = 0;
  ...
  cr_lui_rd_sp_val: cross lui, rd_sp_val{
    //low 12-bit is always zero
    bins rd_sp_val_0 = binsof (lui) intersect {LUI} && binsof (rd_sp_val) intersect {
      32'b0
    };
    bins rd_sp_val_4 = binsof (lui) intersect {LUI} && binsof (rd_sp_val) intersect {
